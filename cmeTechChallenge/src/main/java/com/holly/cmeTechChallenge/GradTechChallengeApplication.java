package com.holly.cmeTechChallenge;

import com.holly.cmeTechChallenge.runner.PrimeRunner;
...
public class GradTechChallengeApplication {
	...
	public static void start(){
		...
		String fileName = "cmeTechChallenge/src/main/resources/primeNumbers.txt";
